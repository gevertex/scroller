...
MIN_GAP = 120  # Minimum horizontal gap between obstacles
MAX_GAP = 250  # Maximum horizontal gap between obstacles
...
# Game state
is_jumping = False
jump_held = False  # Track if space is being held
...
def main():
    global player_y, player_velocity_y, is_jumping, jump_held, obstacles
